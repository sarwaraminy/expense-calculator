...
(function() {
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.register_observers = function() {
	  ...
	  // These lines were moved from the 2 commented elements below based on a tip online. They are now in the 'search_choices click.chosen' event handler
	  // It is to prevent a bug preventing the up arrow scroll from being reset to the bottom of the item box each time you click
	  // https://stackoverflow.com/questions/28887166/vertical-scrolling-issue-in-chosen-jquery-plugin
	  ...
	  */
      ...
      if (this.is_multiple) {
        return this.search_choices.bind('click.chosen', (function(_this) {
          return function(evt) {
			// These 2 lines were moved here from the 2 commented items above based on a tip online.
	        // It is to prevent a bug preventing the up arrow scroll from being reset to the bottom of the item box each time you click
	        // https://stackoverflow.com/questions/28887166/vertical-scrolling-issue-in-chosen-jquery-plugin
		    _this.container_mousedown(evt);
		    _this.container_mouseup(evt);
